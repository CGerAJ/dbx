export default {
  ...
  diagram: {
    ...
    syncDraftCount: "{count} change(s) to sync (create tables / add columns)",
    executeSync: "Execute",
    syncing: "Syncing…",
    ...
    liveTableAddColumnsHint: "Existing columns are read-only. Add columns here, then sync with ALTER ADD COLUMN.",
    liveTableIndexesReadOnly: "Edit indexes for live tables in the table structure editor",
    pendingColumnsBadge: "Pending columns",
    source: "Source",
    target: "Target",
    removeRelationship: "Remove relationship",
